...
class TestConversion(unittest.TestCase):
    ...
    def test_is_valid(self):
        self.assertTrue(convert.is_valid(
            'bitcoincash:qqkv9wr69ry2p9l53lxp635va4h86wv435995w8p2h'))
        self.assertTrue(convert.is_valid(
            '2MwikwR6hoVijCmr1u8UgzFMHFP6rpQyRvP'))
        self.assertFalse(convert.is_valid(
            'bitcoincash:aqkv9wr69ry2p9l53lxp635va4h86wv435995w8p2h'))
        self.assertFalse(convert.is_valid(
            'bitcoincash:qqqqqqqq9ry2p9l53lxp635va4h86wv435995w8p2h'))
        self.assertFalse(convert.is_valid(
            '22222wR6hoVijCmr1u8UgzFMHFP6rpQyRvP'))
        self.assertFalse(convert.is_valid(False))
        self.assertFalse(convert.is_valid('Hello World!'))
        self.assertEqual(convert.to_slp_address('bitcoincash:qr69pdt4wmxmhzffly0q3s7h7gr5rdt02scjsy3sul'),
                         'simpleledger:qr69pdt4wmxmhzffly0q3s7h7gr5rdt02s5fmlyszp')
        self.assertEqual(convert.to_slp_address('1PGpZZ8eW6FWQjWcaJM5cvUo8J5AEbBv9R'),
                         'simpleledger:qr69pdt4wmxmhzffly0q3s7h7gr5rdt02s5fmlyszp')
